...
public class TodosController : ControllerBase
{
    ...
    public async Task<ActionResult<List<TodoModel>>> Get()
    {
        ...
        {
            _logger.LogError(ex, "The GET call to api/Todo failed.");
            return BadRequest();
        }
    }
    ...
    public async Task<ActionResult<TodoModel>> Post([FromBody] string task)
    {
        ...
        {
            _logger.LogError(ex, "The POST call to api/Todo failed. Task value was {Task}", task);
            return BadRequest();
        }
    }
    ...
    public async Task<ActionResult> Put(int todoId, [FromBody] string task)
    {
        ...
        {
            _logger.LogError(ex, "The PUT call to api/Todo/{TodoId} failed. Task value was {Task}", todoId, task);
            return BadRequest();
        }
    ...
    public async Task<IActionResult> Complete(int todoId)
    {
        ...
        {
            _logger.LogError(ex, "The PUT call to api/Todo/{TodoId}/Complete failed.", todoId);
            return BadRequest();
        }
    ...
    public async Task<IActionResult> Delete(int todoId)
    {
        ...
        {
            _logger.LogError(ex, "The DELETE call to api/Todo/{TodoId} failed.", todoId);
            return BadRequest();
        }
